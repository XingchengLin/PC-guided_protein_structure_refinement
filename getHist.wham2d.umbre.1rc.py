            ...
            with open(histfile, 'r') as infile:
                for line in iter(infile.readline, ''):
                    ...
                    if float(tmp[1]) > mostQ1:
                        mostQ1 = float(tmp[1])
                    if float(tmp[2]) < leastUm1:
                        leastUm1 = float(tmp[2])
                    if float(tmp[2]) > mostUm1:
                        mostUm1 = float(tmp[2])

print(str(leastEne) + "\t" + str(mostEne) + "\t" + str(leastQ1) + "\t" + str(mostQ1) + "\t" + str(leastUm1) + "\t" + str(mostUm1))
stepE = 100.0
stepQ1 = 0.05
stepUm1 = 0.05
