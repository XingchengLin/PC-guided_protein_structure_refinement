...
def mapIndex(origIDFile, targetIDFile, residOffset, inputFile, outputFile):
    ...
    for i in my_lt_range(0, length3, 1):
        ...
        if checkflag == 2:
            outfile2.write(dict[line3[0]] + "\t" + dict[line3[1]] + "\t" + line3[2] +
                           "\t" + line3[3] + "\t" + line3[4] + "\t" + line3[5] + "\t" + line3[6] + "\n")
...
if __name__ == "__main__":
    ...
    mapIndex(origIDFile, targetIDFile, residOffset, inputFile, outputFile)
