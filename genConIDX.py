####################################################################################
# This script will generate the natcont.ndx file for gkuh based on the given structure
#
# Input: PDB structure
#
...
def genConIDX(GROfile, conIDX):

    inFile = open(GROfile, 'r')
    outFile = open(conIDX, 'w')
            ...
            if (is_number(line1[3])):
                ...
                for j in my_lt_range(i + 3, length, 1):
                    ...
                    try:
                        ...
                        # Only output the one with native distance smaller than 0.8 nm;
